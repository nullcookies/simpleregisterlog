<?php
    ...
    try {
        ...
        Longman\TelegramBot\TelegramLog::initErrorLog(__DIR__ . "/log/{$bot_username}_error.log");
        Longman\TelegramBot\TelegramLog::initDebugLog(__DIR__ . "/log/{$bot_username}_debug.log");
        Longman\TelegramBot\TelegramLog::initUpdateLog(__DIR__ . "/log/{$bot_username}_update.log");
        ...
        $telegram->executeCommand('hellomessage');
